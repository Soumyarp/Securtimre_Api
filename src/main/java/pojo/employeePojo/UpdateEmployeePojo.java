...
public class UpdateEmployeePojo {
    ...
    private boolean autoShiftEligibility;
    private String bank;
    ...
    private List<String> deviceMapping;
    ...
    private String lastDateOfEmployment;
    ...
    public String getLastDateOfEmployment() {
        return lastDateOfEmployment;
    }

    public void setLastDateOfEmployment(String lastDateOfEmployment) {
    ...
    public boolean isAutoShiftEligibility() {
        return autoShiftEligibility;
    }

    public void setAutoShiftEligibility(boolean autoShiftEligibility) {
        this.autoShiftEligibility = autoShiftEligibility;
    }
    ...
    public List<String> getDeviceMapping() {
        return deviceMapping;
    }

    public void setDeviceMapping(List<String> deviceMapping) {
    ...
    public boolean isOtEligibility() {
